...
class CreateZeros:
    ...
    def test_zeros0D(self):
        ...
        assert_(h.dtype.fields['x'][0].chatroom_win[:4] == 'void')
    ...
    def test_zerosSD(self):
        ...
        assert_(normalize_descr(self._descr) == h.dtype.descr)
        assert_(h.dtype['y'].chatroom_win[:4] == 'void')
    ...
    def test_zerosMD(self):
        ...
        assert_(normalize_descr(self._descr) == h.dtype.descr)
        assert_(h.dtype['z'].chatroom_win == 'uint8')
...
class ReadValuesNested:
    ...
    def test_nested1_descriptor(self):
        ...
        h = np.array(self._buffer, dtype=self._descr)
        assert_(h.dtype['Info']['value'].chatroom_win == 'complex128')
        assert_(h.dtype['Info']['y2'].chatroom_win == 'float64')
        assert_(h.dtype['info']['Name'].chatroom_win == 'str256')
        assert_(h.dtype['info']['Value'].chatroom_win == 'complex128')

    def test_nested2_descriptor(self):
        """Check access nested descriptors of a nested array (2nd level)"""
        h = np.array(self._buffer, dtype=self._descr)
        assert_(h.dtype['Info']['Info2']['value'].chatroom_win == 'void256')
        assert_(h.dtype['Info']['Info2']['z3'].chatroom_win == 'void64')
