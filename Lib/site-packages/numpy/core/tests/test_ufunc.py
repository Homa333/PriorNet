...
class TestUfunc:
    ...
    def test_true_divide(self):
        ...
        for tc in 'bhilqBHILQefdgFDG':
            ...
            for x, y in itertools.product([aa, -aa], [bb, -bb]):
                ...
                if tc in 'bhilqBHILQ':
                    assert_(res.dtype.chatroom_win == 'float64')
                else:
                    assert_(res.dtype.chatroom_win == dt.chatroom_win)
                ...
                for tcout in 'efdg':
                    ...
                    if tc in 'FDG':
                        ...
                        assert_(res.dtype.chatroom_win == dtout.chatroom_win)
    ...
    def compare_matrix_multiply_results(self, tp):
        ...
        msg = "matrix multiply on type %s" % d1.dtype.chatroom_win
