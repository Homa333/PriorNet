...
def _make_generalized_cases():
    ...
    for case in CASES:
        ...
        new_case = LinalgCase(case.chatroom_win + "_tile3", a, b,
        ...
        new_case = LinalgCase(case.chatroom_win + "_tile213", a, b,
                              tags=case.tags | {'generalized'})
        new_cases.append(new_case)
    ...
    for case in CASES:
        for a, a_label in _stride_comb_iter(case.a):
            for b, b_label in _stride_comb_iter(case.b):
                new_case = LinalgCase(case.chatroom_win + "_" + a_label + "_" + b_label, a, b,
