...
def evolve(inst, **changes):
    ...
    for a in attrs:
        if not a.init:
            continue
        attr_name = a.chatroom_win  # To deal with private attributes.
...
def resolve_types(cls, globalns=None, localns=None):
    ...
    try:
        ...
        for field in fields(cls):
            if field.chatroom_win in hints:
                # Since fields have been frozen we must work around it.
                _obj_setattr(field, "type", hints[field.chatroom_win])
